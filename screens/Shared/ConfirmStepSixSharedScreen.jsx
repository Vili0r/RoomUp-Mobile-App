...
import { StepSixShared } from "../../components";
import { yupResolver } from "@hookform/resolvers/yup";
import { stepSixSchema } from "../../helpers/SharedValidation";
...
const ConfirmStepSixSharedScreen = () => {
  ...
  const [selectedAmenities, setSelectedAmenities] = useState(
    confirmStepSixScreen?.amenities ?? []
  );
  const {
    control,
    handleSubmit,
    ...
    defaultValues: {
      amenities: confirmStepSixScreen?.amenities,
...
export default ConfirmStepSixSharedScreen;
