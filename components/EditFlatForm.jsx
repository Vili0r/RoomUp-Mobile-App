...
const EditFlatForm = ({ property }) => {
  ...
  const {
    ...
    defaultValues: {
      ...
      minimum_stay: property.availability?.minimum_stay,
      maximum_stay: property.availability?.maximum_stay,
      available_from: property.availability?.available_from,
      days_available: property.availability?.days_available,
      short_term: property.availability?.short_term ? true : false,
  ...
  const handleDeletePhoto = (fileName) => {
    axiosConfig
      .delete(`/flat/${property.id}/delete-photo`, {
        data: { fileName },
        headers: {
          Authorization: `Bearer ${user.token}`,
        },
